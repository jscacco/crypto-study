...
static void reset(uint32_t digest[], std::string &buffer, uint64_t &transforms,
		  uint32_t val1 = 0x67452301, uint32_t val2 = 0xefcdab89,
		  uint32_t val3 = 0x98badcfe, uint32_t val4 = 0x10325476,
		  uint32_t val5 = 0xc3d2e1f0, const std::string start_buf = "",
		  uint64_t start_transforms = 0)
{
...
SHA1::SHA1(const uint32_t val1, const uint32_t val2, const uint32_t val3,
	   const uint32_t val4, const uint32_t val5, const std::string start_buf,
	   const uint64_t start_transforms) {
  reset(_digest, _buffer, _transforms, val1, val2, val3, val4, val5, start_buf, start_transforms);
}
